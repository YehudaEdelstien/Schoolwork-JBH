...
class SchoolForm extends Component {
    ...
    inputFieldData = {
        ...
        age: { labelText: "Age", type: "text", defaultValue: 0,},
        address: { labelText: "Address", type: "text", defaultValue: "",},
        homeroomClassNumber: { labelText: "Homeroom class number", type: "text", defaultValue: 0,},
        studentId: { labelText: "Student ID", type: "text", defaultValue: "",},
        favoriteLunch: { labelText: "Favorite lunch", type: "radio", options: ["Shnitzel", "Hamburger", "Chicken", "Fish", "Corn Shnitzel"], defaultValue: "",},
    }
